window.textos = {
  docente: {
    ...
    piscis: {
      ...
      `,
      primer: `
        El inicio del año podrá ser abrumador si no ponés límites claros.
  ...
  "tecnico-administrativo": {
    aries: {
      verano: `
        El verano será tu tregua necesaria tras un diciembre de actas y cierres frenéticos.
        Tu cuerpo pedirá desconexión total de las pantallas.
        Aprovecharás para resetear la paciencia; Aries necesita aire libre para no empezar marzo con los cables pelados.
        Descansar será tu mejor inversión para no estallar ante el primer pedido fuera de término en el regreso.
      `,
      primer: `
        El inicio del año traerá un aluvión de trámites y sistemas que no funcionan como deberían.
        Serás el primero en detectar las fallas del sistema informático y querrás resolverlo todo ya.
        El desafío será no pelearte con la burocracia ministerial; elegí tus batallas para no agotar tu fuego en formularios que no dependen de vos.
      `,
      segundo: `
        A mitad de año, tu agilidad para resolver lo que otros traban te hará ganar el respeto de los pasillos.
        Lograrás ordenar procesos que venían lentos.
        Tu liderazgo será práctico: menos queja y más solución.
        Empezarás a trabajar en red con otras oficinas para blindar el funcionamiento administrativo del instituto.
      `,
      cierre: `
        Llegarás a diciembre con la satisfacción de haber mantenido la máquina andando.
        Habrás aprendido que tu impulso es valioso cuando se organiza.
        Cerrarás el año sabiendo que, sin tu gestión, el Alicia se detiene.
        Te vas a descansar con la frente en alto y el sistema —finalmente— bajo control.
      `
    },
    tauro: {
      verano: `
        El verano será tu refugio de previsibilidad.
        Necesitarás orden en tu casa y en tus días para compensar el caos de expedientes del año anterior.
        No querrás saber nada de cambios de último momento.
        Tu descanso será lento, físico y muy merecido, construyendo la paciencia que marzo te va a exigir.
      `,
      primer: `
        El primer cuatrimestre traerá normativas nuevas que te obligarán a cambiar tu forma de trabajar.
        Te generará resistencia, pero tu tenacidad será tu mejor aliada.
        Mientras todos se desesperan por la incertidumbre, vos te mantendrás firme en tu escritorio, garantizando que lo importante se siga registrando.
      `,
      segundo: `
        A mitad de año, tu estabilidad será el ancla de la oficina.
        Docentes y estudiantes buscarán tu mirada tranquila cuando el sistema colapse.
        Descubrirás que tu ritmo, aunque parezca lento, es el único que llega al final sin errores.
        Tu constancia sostendrá la continuidad administrativa en un contexto hostil.
      `,
      cierre: `
        Cerrarás el año habiendo demostrado que la prolijidad es una forma de resistencia.
        No se te escapó ni un legajo.
        Te irás con la paz de quien sabe que su trabajo es el suelo firme sobre el que camina toda la institución.
        El 2026 te consagra como el pilar silencioso del Alicia.
      `
    },
    geminis: {
      verano: `
        Tu verano será una red de conversaciones y lecturas livianas.
        Necesitarás limpiar la cabeza de códigos, resoluciones y normativas densas.
        Te mantendrás en contacto con tus compañeros, intercambiando anécdotas del año que pasó, pero buscando aire nuevo en temas que nada tengan que ver con el trabajo.
      `,
      primer: `
        El regreso será un festival de consultas.
        Serás el que mejor explique los nuevos procedimientos porque los entendés antes que nadie.
        El desafío será no dispersarte en mil ventanillas a la vez.
        Tu rapidez mental será clave para traducir la jerga ministerial a un lenguaje humano que los estudiantes agradezcan.
      `,
      segundo: `
        A mitad de año, serás el puente de información entre las distintas áreas.
        Tu oficina será un nodo de comunicación donde se resuelven malentendidos antes de que lleguen a mayores.
        Descubrirás que comunicar bien es tan importante como cargar datos.
        Tu habilidad para circular la información evitará conflictos institucionales.
      `,
      cierre: `
        Terminarás el año habiendo ordenado el caos a través de la palabra.
        Lograste que la oficina sea un lugar de encuentro y claridad.
        Te irás sabiendo que tu lucidez mental fue el lubricante que permitió que la maquinaria administrativa del Alicia no se trabara en los momentos críticos.
      `
    },
    cancer: {
      verano: `
        El verano te pedirá nido y silencio.
        Te costará soltar la preocupación por ese estudiante que no terminó el trámite o el colega que quedó en la cuerda floja.
        Necesitarás que te cuiden a vos para recuperar la energía que pusiste en sostener el clima de la oficina.
        Tu descanso será emocional y reparador.
      `,
      primer: `
        El inicio del año te pondrá en la primera línea de la angustia ajena.
        Recibirás a estudiantes y docentes preocupados por la crisis.
        Tu empatía será un refugio, pero el desafío será no llevarte esos problemas a tu casa.
        Aprenderás a poner un límite protector en tu escritorio.
      `,
      segundo: `
        A mitad de año, transformarás la oficina en un espacio más humano.
        Un mate compartido, una escucha atenta o una palabra de aliento cambiarán el clima de trabajo.
        Lograrás que la administración no sea solo papeles, sino cuidado colectivo.
    ...
    leo: {
      verano: `
        El verano te devolverá el brillo personal fuera del mostrador.
        Necesitarás actividades que te hagan sentir protagonista de tu vida.
        Recargarás tu energía con disfrute y sol, preparándote para volver a ser referente.
      `,
      primer: `
        En el regreso sentirás la falta de reconocimiento por las horas extras y el esfuerzo invisible.
        El desafío será seguir trabajando con excelencia sin depender del aplauso.
        Aprenderás a liderar desde tu puesto, organizando al equipo con tu energía.
      `,
      segundo: `
        A mitad de año, tu confianza contagiará a tus compañeros.
        Propondrás mejoras y nuevas formas de organizar el espacio.
        Tu autoridad natural dará seguridad en los momentos de caos.
      `,
      cierre: `
        Cerrarás el año sabiendo que tu ejemplo movilizó a los demás.
        No necesitaste un cargo jerárquico para ser líder.
        Te irás con la satisfacción de haber fortalecido el espíritu del Alicia.
      `
    },
    virgo: {
      verano: `
        Tu descanso será el orden.
        Te costará no pensar en cómo mejorar los archivos del instituto incluso lejos de la oficina.
        El desafío será permitirte el ocio sin sentir culpa.
      `,
      primer: `
        El primer cuatrimestre será un catálogo de errores ajenos que detectarás antes que nadie.
        El aprendizaje será no cargar con la culpa de la ineficiencia del sistema.
        Hacé tu parte con excelencia y soltá el resto.
      `,
      segundo: `
        A mitad de año, tu meticulosidad evitará errores graves.
        Tu método se volverá referencia para toda la oficina.
        Descubrirás que la prolijidad es defensa institucional.
      `,
      cierre: `
        Terminarás el año con todo en su lugar.
        Habrás aprendido a delegar lo que no requiere tu precisión.
        Tu labor técnica protegió derechos y sostuvo al Alicia.
      `
    },
    libra: {
      verano: `
        El verano será para recuperar la armonía personal.
        Necesitarás belleza y calma después de un año mediando tensiones.
        Tu descanso será social, pero sin demandas.
      `,
      primer: `
        El regreso te encontrará suavizando tensiones en la ventanilla.
        Serás la cara amable frente al reclamo exaltado.
        Aprenderás a decir que no con equilibrio.
      `,
      segundo: `
        A mitad de año, tu oficina será el lugar de los acuerdos.
        Tu diplomacia sostendrá la convivencia institucional.
        Serás arquitecto de un clima laboral sano.
      `,
      cierre: `
        Llegarás a diciembre habiendo evitado innumerables incendios emocionales.
        Tu trabajo invisible sostuvo la justicia cotidiana.
        El Alicia te agradece por ser su punto de equilibrio.
      `
    },
    escorpio: {
      verano: `
        El verano será de silencio y purificación.
        Necesitarás soltar tensiones acumuladas y evaluar qué batallas seguir.
        Tu descanso será una inmersión profunda.
      `,
      primer: `
        El inicio del año te mostrará la realidad sin filtros.
        Percibirás las movidas políticas antes que otros.
        Tu desafío será usar esa lucidez para proteger, no para desgastarte.
      `,
      segundo: `
        A mitad de año, tu compromiso con la verdad será innegociable.
        No permitirás injusticias administrativas.
        Te volverás un referente ético dentro de la gestión.
      `,
      cierre: `
        Cerrarás el año habiendo transformado tu espacio de trabajo.
        Nada quedó oculto.
        Te irás sabiendo que dejaste una huella de honestidad.
      `
    },
    sagitario: {
      verano: `
        El verano será tu válvula de escape.
        Necesitarás recuperar horizonte y perspectiva.
        Tu descanso será mental y expansivo.
      `,
      primer: `
        Al volver, los trámites repetitivos te pesarán más.
        Encontrarás sentido recordando que cada papel sostiene una historia.
        Traerás humor cuando el sistema se ponga denso.
      `,
      segundo: `
        A mitad de año, propondrás cambios que agilizarán procesos.
        Tu optimismo abrirá puertas.
        Recordarás a todos por qué trabajan por la educación pública.
      `,
      cierre: `
        Terminarás el año con cansancio físico, pero con el espíritu libre.
        Lograste que la oficina sea un espacio de posibilidad.
        El Alicia te necesita siempre mirando más allá del mostrador.
      `
    },
    capricornio: {
      verano: `
        Te costará desconectar del todo.
        Tu descanso será planificar para que nada falle.
        El desafío será confiar en que el mundo sigue girando.
      `,
      primer: `
        El regreso te encontrará como la roca de la gestión.
        Estudiarás la normativa antes que nadie.
        El riesgo será la sobrecarga; aprendé a delegar.
      `,
      segundo: `
        A mitad de año, tu eficiencia será legendaria.
        Tu autoridad nacerá del compromiso.
        La comunidad confiará en vos.
      `,
      cierre: `
        Cerrarás el año con la tranquilidad del deber cumplido.
        La estructura administrativa se sostuvo gracias a tu rigor.
        El 2026 te consagra como guardián de la continuidad institucional.
      `
    },
    acuario: {
      verano: `
        El verano será un laboratorio de ideas.
        Pensarás cómo digitalizar y simplificar procesos.
        Necesitarás aire nuevo y pensamiento libre.
      `,
      primer: `
        El regreso te enfrentará a los “siempre se hizo así”.
        Propondrás lo nuevo sin perder el vínculo.
        Serás el hacker creativo del sistema administrativo.
      `,
      segundo: `
        A mitad de año, tus ideas empezarán a circular.
        La comunicación será más ágil.
        Descubrirás que se puede ser administrativo sin perder rebeldía.
      `,
      cierre: `
        Terminarás el año habiendo movido estructuras.
        Nada quedó igual.
        El 2026 te deja como arquitecto de la administración que viene.
      `
    },
    piscis: {
      verano: `
        El verano será tu tiempo de sanación psíquica.
        Necesitarás arte, música o mar.
        Tu descanso será disolver la identidad laboral.
      `,
      primer: `
        El regreso podrá ser abrumador.
        Aprenderás a poner un límite invisible, pero firme.
        Tu sensibilidad será brújula, no carga.
      `,
      segundo: `
        A mitad de año, tu intuición resolverá lo imposible.
        Tu trato humano desarmará enojos.
        La oficina se volverá refugio.
      `,
      cierre: `
        Llegarás a diciembre con la sensibilidad intacta.
        Aprendiste a navegar sin ahogarte.
        El Alicia te agradece por recordar que detrás de cada trámite hay una persona.
      `
    }
  },
  estudiante: {
    ...
    cancer: {
      ...
      `,
      primer: `
        El primer cuatrimestre te golpeará en el costado más sensible.
        El clima de estudio estará cargado, habrá malestar no dicho y compañeros que pedirán más contención de la que podrás dar.
      ...
      segundo: `
        ...
        Eso fortalecerá tus vínculos: cuando muestres tu límite, otros entenderán que también pueden tener uno.
    ...
    virgo: {
      ...
      primer: `
        ...
        El aprendizaje será este: no todo merecerá ser corregido de inmediato; hay que saber cuándo soltar el control.
        La esperanza estará en la eficiencia compartida.
      `,
      segundo: `
        Con el correr de los meses, empezarás a soltar el rigor.
        Delegarás tareas, compartirás responsabilidades y aceptarás que cierto desorden funcional no será una catástrofe académica.
    ...
    libra: {
      ...
      `,
      primer: `
        El inicio del año traerá tensiones en los grupos de estudio: opiniones encontradas y trabajos que no avanzan al mismo ritmo.
    ...
    escorpio: {
      verano: `
        El verano será un tiempo de introspección profunda e inevitable.
        Necesitarás silencio, profundidad y tiempo sin la necesidad de dar explicaciones superficiales.
        Descansar, para vos, será procesar todo lo que quedó pendiente a nivel emocional y estratégico.
        Algo estructural se estará moviendo en tu interior; evaluarás qué vínculos de estudio merecen seguir.
        Aprovecharás para purificar tu energía y prepararte para las transformaciones.
      `,
      primer: `
        El primer cuatrimestre no esquivará el conflicto; de hecho, lo atraerá para poder depurarlo.
        Aparecerán tensiones reales en los grupos, juegos de poder y verdades incómodas.
      ...
      segundo: `
        ...
        Cambiarán tus relaciones, los límites que pongas y lo que ya no estarás dispuesto a tolerar.
        No buscarás comodidad académica, buscarás verdad y autenticidad en el proceso de estudio.
        Soltar lo viejo podrá doler, pero te permitirá renacer con más fuerza y claridad.
    ...
    sagitario: {
      verano: `
        El verano activará tu necesidad de horizonte y de sentido.
        Leerás, pensarás e imaginarás otros modos de estudiar; te negarás a que el año que empieza sea solo supervivencia.
        Necesitarás sentir que habrá una meta más alta, un propósito que trascienda la cursada.
        Tu descanso será mental; te recargarás expandiendo tus conocimientos y soñando con el futuro.
        Aprovecharás para conectar con filosofías o ideas que te den un marco de esperanza.
      `,
      primer: `
        El primer cuatrimestre apretará con calendarios rígidos y exigencias de corto plazo.
        Eso generará fricción con tu necesidad de amplitud.
        Vos seguirás mirando más allá del día a día, buscando el sentido de cada tarea.
        Sagitario necesitará propósito para sostener el esfuerzo, y cuando ese sentido flaquee, aparecerá el cansancio.
        Tu energía estará en la inspiración.
      `,
      segundo: `
        A mitad de año, compartirás ideas, abrirás debates inesperados y propondrás miradas que oxigenarán la conversación del grupo.
      ...
      cierre: `
        El año terminará con fatiga física, pero no con vacío existencial.
        El sentido seguirá ahí, intacto y fortalecido por las acciones que emprendiste.
        Tal vez no lograste la gran reforma que soñabas, pero sembraste preguntas que van a germinar.
        Te irás sabiendo que inspiraste a otros a ver un poco más lejos.
      `
    },
    capricornio: {
      verano: `
        ...
        Tu mayor tarea estival será delegar mentalmente y dejar que el mundo gire sin que lo impulses.
        Conectarás con tu cuerpo; el descanso físico será la mejor inversión para tu rendimiento.
      `,
      primer: `
        El inicio del año te colocará en el lugar de sostén y de columna vertebral del grupo.
        Organización, continuidad y cumplimiento de tiempos: muchas cosas funcionarán porque alguien las mantendrá en marcha, y muchas veces ese alguien serás vos.
        Tu seriedad y compromiso serán pilares, pero el riesgo será normalizar la sobrecarga.
        Empezarás a trabajar en la delegación activa.
      `,
      segundo: `
        A mitad de año el peso se hará sentir con fuerza, y por primera vez la resistencia no será la respuesta.
        Capricornio reconocerá que sostener el estudio no significará hacerlo en solitario.
        Pedir ayuda se volverá una posibilidad real.
        Descubrirás la eficiencia de la colaboración y te sorprenderás al ver que el trabajo compartido mejora todo.
        Este será tu gran cambio.
      `,
      cierre: `
        El año terminará gracias al trabajo silencioso y constante de quienes cargaron más de lo justo.
        Esta vez te irás reconociendo en esa tarea, pero sin romantizar el desgaste.
        Entendiste que tu valor no estará solo en lo que producís, sino en tu capacidad de construir estructuras duraderas.
        Te llevarás la lección de que el verdadero éxito será llegar sin sacrificar tu bienestar.
      `
    },
    acuario: {
      verano: `
        El verano será un laboratorio mental: un espacio para pensar alternativas radicales al estudio tradicional.
        ...
        Mantendrás esas ideas frescas; serán tu arsenal para marzo.
      `,
      primer: `
        El primer cuatrimestre te enfrentará a normas rígidas y lógicas que no contemplan la diversidad real.
        Sentirás el roce constante entre lo posible y lo permitido.
        Podrás frustrarte, pero tu rol será agitar las preguntas difíciles.
        Evitarás el cinismo y canalizarás esa energía en buscar soluciones ingeniosas.
        Serás la voz del cambio.
      `,
      segundo: `
        A mitad de año, las redes humanas se volverán tu refugio y tu motor.
        Ideas que no prosperan oficialmente circularán por canales informales que vos ayudarás a crear.
        Descubrirás la potencia de la comunidad y del trabajo en red.
        La esperanza florecerá en los márgenes, y vos serás el jardinero.
      `,
      cierre: `
        El año terminará sin una revolución visible, pero con muchas semillas plantadas.
        Tu influencia habrá sido silenciosa pero profunda.
        Un cambio de mentalidad precede siempre al cambio de estructura.
        Te irás con la certeza de que tu visión de futuro ya está circulando.
      `
    },
    piscis: {
      verano: `
        El verano te volverá permeable y sensible a los climas emocionales de tu entorno.
        Necesitarás pausa, retiro y mucho contacto con la naturaleza o el arte.
      ...
      primer: `
        El inicio del año podrá ser abrumador si no ponés límites claros.
        Absorberás climas, exigencias y estados de ánimo que no siempre serán tuyos.
        Al comienzo te costará poner límites por temor a ser insensible.
        El desafío será aprender que podés ser empático sin sacrificar tu espacio.
        Tu sensibilidad deberá ser brújula, no esponja.
      `,
      segundo: `
        A mitad de año aprenderás a compartir lo que sentís y a verbalizar la carga emocional.
        Poner palabras a lo difuso ordenará tu mundo interior.
        Descubrirás que al hablar, tus compañeros no te juzgan, sino que te ofrecen contención.
        Esta práctica será tu gran logro.
      `,
      cierre: `
        El año terminará con más contención y menos confusión interna.
        No porque te endureciste, sino porque conocés mejor tus límites.
        El 2026 habrá sido el año en que aprendiste a navegar las aguas emocionales sin ahogarte.
        Tu esperanza residirá en la conexión profunda que ahora podés elegir.
      `
    }
  },
  graduado: {
